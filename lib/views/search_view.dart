...
class ProductSearch extends SearchDelegate<String> {
  ...
  SearchPageViewModelSingleton searchViewModel = SearchPageViewModelSingleton.getState();
          ...
          switch (snapshot.connectionState) {
            ...
            default:
              if (snapshot.hasError || snapshot.data.isEmpty) {
                ...
                searchViewModel.getSuggestions(snapshot.data, query);
  ...
  Widget buildResultSuccess(BuildContext context) {
    double minPrice = searchViewModel.priceMinMax(this.products, 0);
    double maxPrice = searchViewModel.priceMinMax(this.products, 1);
    RangeValues _priceRangeValues = RangeValues(minPrice, maxPrice);

    return StatefulBuilder(builder: (context, _setState) {
      ListView productsWidget() {
        List<Product> sortedProducts = searchViewModel.applySort(this.products, sortValue);
