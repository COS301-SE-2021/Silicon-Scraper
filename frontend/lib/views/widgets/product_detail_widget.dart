...
//                            height: (MediaQuery.of(context).size.height)*0.1,
                          ...
                          child: Wrap(
                            ...
                            children: [
                              Text(
                                "${widget.state.item.brand + " " + widget.state.item.model}",
                                style: TextStyle(
                            ...
                            children: [
                              Container(
                                child: widget.state.item
                                    .getAvailabilityTextFormat("productDetail"),
                              ),
                              Text(
                                'R ${widget.state.item.price.toStringAsFixed(2)}',
                                style: TextStyle(
...
Widget predictionWidget(PredictionViewModel p, BuildContext context) {
  ...
  return ChangeNotifierProvider<PredictionViewModel>(
    create: (_) => p,
    child: Consumer<PredictionViewModel>(builder: (context, p, Widget child) {
      return Container(
        child: p.predict != null
            ? Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        child: Text('R ${p.predict.price.toStringAsFixed(2)}',
                            style: TextStyle(
